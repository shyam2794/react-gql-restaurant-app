...
class PrintToKitchenContainer extends Component {
   render() {
        ...
        return (
            ...
            <ReactToPrint
            trigger={() => <Button outline color="primary"> Print </Button>}
            ...
            <Link to="/Booking"><Button outline color="primary"> View Booking </Button> </Link>
            </Col>
            </Row>
            </div>
            </Col>
            <Col sm="4" xs="4" md="4" lg="4">
            <PrintToKitchenContent ref={el => (this.componentRef = el)}  orderDetails={this.props.location.state} />
            </Col>
            </Row>
            </div>
