...
class PrintToKitchenContent extends Component 
  {
       ...
       let order = removeZero.filter(value => value.table_no === orderDetails.table_id && value.table_type === orderDetails.table_type)
        
    return (
        <div style={styles.containerStyle}>
        <Row>
        <Col sm="12" xs="12" md="12" lg="12">
        <h4 style={styles.header} className="text-center"> Hotel KVK </h4>
        </Col>
        </Row>
        <Row>
        ...
        <Row>
        <Col sm="12" xs="12" md="12" lg="12">
        <h6 className="text-center"> Order From:{orderDetails.table_type} </h6>
